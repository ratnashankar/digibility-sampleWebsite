...
export default function ContactPage() {
    ...
    return (
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-5 flex flex-col lg:flex-row gap-6 items-center w-full">

        <div className="flex-1">
          <h1 className="text-4xl lg:text-7xl font-bold mb-3 leading-tight">
            Let’s talk. We’re here to help.
          </h1>
          <p className="text-xl lg:text-2xl  text-gray-200 max-w-[60ch]">
        ...
        <div className="w-[90vw] mb-10 lg:w-[30vw] bg-white/10 border border-white/25 rounded-2xl p-5">
          <div className="flex flex-wrap flex-col gap-6">
            {[
              ...
              <div
                key={c.tag}
                className="bg-white text-gray-900 border border-gray-300 rounded-2xl p-4 flex-1 min-w-[240px] w-full  mx-auto lg:w-full"
              >
                <span className="inline-block px-3 py-1 bg-[#EEF5FF] text-blue-600 text-lg font-semibold rounded-full">
                  {c.tag}
                </span>
                <h4 className="text-xl font-bold mt-2">{c.title}</h4>
            ...
            <section className="relative min-h-screen flex items-center justify-between  overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <section
                        id="support"
                        className="max-w-[1200px] px-[5vw] lg:px-[11vw] py-10 flex flex-col lg:flex-row gap-6"
                    >
                        ...
                        <div className="bg-white  lg:w-[20vw] h-fit shrink-0 rounded-xl border p-5">
                    ...
                    <section id="faq" className="max-w-[1200px] mx-[5vw]  lg:mx-[10vw] pb-10">
