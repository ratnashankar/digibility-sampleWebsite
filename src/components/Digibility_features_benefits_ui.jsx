...
export default function FeaturesBenefitsPage() {
  const [audience, setAudience] = useState("spark"); 
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-[10vh] pb-8 text-center">
      ...
      <div className="fixed bottom-4 inset-x-0 px-4">
        <div className="max-w-3xl mx-auto backdrop-blur bg-white/80 border shadow-lg rounded-2xl p-3 flex items-center justify-between">
          <div className="text-sm">
            <div className="font-semibold">Ready to turn consistency into growth?</div>
            <div className="text-gray-600">Start with Spark, upgrade to Momentum, scale with Apex.</div>
          </div>
          <a href="#pricing" className="px-4 py-2 rounded-xl bg-blue-600 text-white hover:bg-blue-700">View Plans</a>
        </div>
      </div>
 </div>
  );
